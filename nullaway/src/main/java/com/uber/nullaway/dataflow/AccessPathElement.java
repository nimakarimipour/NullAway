...
public final class AccessPathElement {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AccessPathElement) {
            ...
            return this.javaElement.equals(otherNode.javaElement) && (constantArguments == null ? otherNode.constantArguments == null : constantArguments.equals(otherNode.constantArguments));
        } else {
            return false;
        }
    }
    ...
    public String toString() {
        return "APElement{" + "javaElement=" + javaElement.toString() + ", constantArguments=" + Arrays.deepToString(constantArguments != null ? constantArguments.toArray() : null) + '}';
    }
}
